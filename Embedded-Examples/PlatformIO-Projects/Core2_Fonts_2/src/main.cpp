...
void loop() {
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF10, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF11, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF12, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF13, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF14, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF15, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF16, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF17, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF18, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF19, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF20, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF21, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF22, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF23, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF24, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF25, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF26, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF27, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF28, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF29, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF30, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF31, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF32, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF33, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF34, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF35, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF36, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF37, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF38, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF39, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF40, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF41, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF42, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF43, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF44, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF45, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF46, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF47, 160, 60,
                      GFXFF);  // Print the string name of the font
    ...
    // M5.Lcd.fillScreen(TFT_BLACK);
    M5.Lcd.setFreeFont(FF18);  // Select the font
    M5.Lcd.drawString(sFF48, 160, 60,
                      GFXFF);  // Print the string name of the font
